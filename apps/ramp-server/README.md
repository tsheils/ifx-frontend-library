...
Please follow [these instructions](../ramp-client/CLIENT_INSTRUCTIONS.md) to run the client application and [these instructions](SERVER_INSTRUCTIONS.MD) to run the API.
