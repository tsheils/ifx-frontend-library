...
export const getRampState = createFeatureSelector<State>(RAMP_STORE_FEATURE_KEY)
...
export const getReactionClassEnrichment = createSelector(
  getRampState,
  (state: State) => state.reactionClassEnrichments
)
