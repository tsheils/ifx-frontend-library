  ...
  ifxTools: {
    ...
    entities: {
      ...
      'qhts-heatmap-browser': {
        ...
        description:
          'This heatmap tool provides rapid viewing of assay profiles on compounds. It has several features such as ability to sort heatmap by compound similarity and/or activity profiles of selected assays. Selecting individual hetamap cells provides compound structure and associated qHTS curves.',
        toolType: 'java webstart app',
      ...
      'qhts-sample-client': {
        ...
        contact: 'Yuhong Wang',
        description:
          'This application provides access to all chemical structure info of NCGC sample collections.',
        toolType: 'java webstart app',
      ...
      'ncatsfind-excel': {
        ...
        description:
          'Resolver and standardizer for names, structures, and chemical properties',
      ...
      'shiny-apps': {
        ...
        contact: 'Lu Chen',
        description:
          'Various applications for qhts, matrix and rnai. Usually small, single function apps (generate plot or do a specific statistical test)',
      ...
      'qhts-tools': {
        ...
        contact: 'Yuhong Wang',
        description:
          'A list of java web applications that help process qHTS data',
        url: 'http://qhts/ws',
      ...
      canvass: {
        ...
        contact: 'Tongan Zhao',
        description:
          'Web interface to CanWeb interface to NCATS CANVASS datasets. CANVASS is a project working with total synthesis and natural product isolation groups to access novel natural products for high-throughput screening.vass assays',
        toolType: 'website',
      ...
      'scaffold-hopper': {
        ...
        description:
          'scaffold hopping, r-group decomposition, structure searching pubmed',
        toolType: 'java webstart app',
      ...
      'ncatsfind-resolver': {
        ...
        contact: 'Tyler Peryea',
        description:
          'Resolves a name/code/structure to many other name/code/structures/properties',
        toolType: 'webservice',
      ...
      renderer: {
        ...
        contact: 'Tyler Peryea',
        description:
          'Renders a structure based on a smiles string, has lots of low-level options',
        toolType: 'webservice',
      ...
      overlap: {
        ...
        contact: 'Dac-Trung Nguyen',
        description:
          'tool for finding overlap between molecular dataset with our library or any datasets',
      ...
      'similarity-': {
        ...
        contact: 'Dac-Trung Nguyen',
        description:
          'tool for finding similarity between any two molecular datasets',
      ...
      bioplanet: {
        ...
        contact: 'Tongan Zhao | Ruili Huang',
        description:
          'website to browse and display curated pathways for gene set enrichment analysis',
        toolType: 'website',
    ...
    loaded: true,
    audienceList: ['Data Scientist', 'Biologist', 'Chemist', 'Developer'],
    categoryList: [
      'qhts data',
      'NCGC compounds',
      'chemistry',
