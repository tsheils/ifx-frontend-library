...
import { Article, PubtatorAnnotation } from "@ncats-frontend-library/models/rdas";
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatCardModule, MatIconModule, MatButtonModule, ArticleListCardComponent],
