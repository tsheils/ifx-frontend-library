...
import { FormGroup, FormsModule, ReactiveFormsModule, FormControlName } from "@angular/forms";
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatRadioButton, MatRadioGroup, FormsModule, ReactiveFormsModule, MatLabel, MatFormField, MatInput, MatSelect, MatOption],
