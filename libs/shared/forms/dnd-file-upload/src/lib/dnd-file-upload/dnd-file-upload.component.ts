import { Component, Directive, HostListener, input, output, signal } from '@angular/core';
...
@Component({
  ...
  imports: [CommonModule, MatIcon, MatIconButton, MatProgressSpinner, DndFileInputDirective, MatButton],
